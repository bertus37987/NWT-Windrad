...
#!/usr/bin/env python3
"""
Rotor Hub — Upper Disc  8-Rod
pip install cadquery  →  python rotor_hub_upper_8rod.py
"""
...
print("Exporting...")
cq.exporters.export(disc, "output/rotor_hub_upper_8rod.stl")
cq.exporters.export(disc, "output/rotor_hub_upper_8rod.step")
...
print("Done → output/rotor_hub_upper_8rod.stl + .step")
